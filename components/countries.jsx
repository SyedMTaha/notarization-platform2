...
//         className={`w-full h-[60px] px-4 py-3 border rounded-lg cursor-pointer flex items-center justify-between bg-white transition-all duration-200 ${
//           error ? 'border-red-300' : 'border-gray-300 hover:border-gray-400'
//         } ${isOpen ? 'border-blue-500 ring-2 ring-blue-200' : ''}`}
//       >
//         <span className={`text-base ${value ? 'text-gray-900' : 'text-gray-500'}`}>
