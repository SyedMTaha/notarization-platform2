...
// messsages container styles
const messageContainerStyle = {
  maxHeight: "300px",
  display: "none",
};
const messageShowContainerStyle = {
  maxHeight: "300px",
};
const MessageDropdown = (props) => {
  const [dropdownOpen, setDropdownOpen] = useState(false);
  const [messageContentStyle, setMessageContentStyles] = useState(
  ...
  const toggleDropdown = () => {
    ...
    setMessageContentStyles(
      messageContentStyle === messageContainerStyle
        ? messageShowContainerStyle
        : messageContainerStyle
    );
  };
  const handleClearMessage = (index) => {
  ...
  return (
    <Dropdown show={dropdownOpen} onToggle={toggleDropdown}>
      ...
      >
        <i className="fe-mail noti-icon font-22"></i>
        ...
        <div onClick={toggleDropdown}>
          <div className="p-2 border-top-0 border-start-0 border-end-0 border-dashed border">
            <div className="row align-items-center">
              <div className="col">
                <h6 className="m-0 font-16 fw-semibold">Messages</h6>
              </div>
          ...
          <SimpleBar className="px-1" style={messageContentStyle}>
