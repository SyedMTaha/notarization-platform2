...
const styles = {
  ...
  title: {
    ...
    color: "#111827",
    margin: 0,
    fontFamily: "'Poppins', sans-serif", // Add Poppins here
  },
  grid: {
    display: "grid",
        ...
        <div style={styles.card}>
          ...
          <div style={styles.cardBody}>
            <div style={styles.paymentMethod}>
              ...
              <div style={{ flex: 1 }}>
                <div style={{ fontSize: "14px", fontWeight: "500", color: "#111827" }}>Visa ending in 4242</div>
                <div style={{ fontSize: "12px", color: "#6b7280" }}>Expires 12/2025</div>
              </div>
              <div style={{ fontSize: "12px", color: "#10b981", fontWeight: "500" }}>Default</div>
            </div>
            <div style={{ display: "flex", gap: "12px" }}>
              <button style={{ ...styles.button, ...styles.primaryButton }}>Add Payment Method</button>
              <button style={{ ...styles.button, ...styles.outlineButton }}>Update Billing</button>
            </div>
          </div>
        </div>
